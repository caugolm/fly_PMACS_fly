...
if [[ $# -lt 3 ]] ; then
	...
	echo "See setting_up_your_config_file.md for more details on how to set up your config_file"
...
cmd="${scripts_dir}/dcm2bids.sh ${subj} ${sess} ${scripts_dir} ${dcm2bids_conda_path} ${dicom_base} ${bids_base} ${heuristic_path} ${calculate_add_motion}"
echo $cmd 
$cmd 
